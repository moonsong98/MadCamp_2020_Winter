...
function addTSInstanceToCache(key, instanceName, instance) {
    var _a;
    const instances = (_a = instanceCache.get(key)) !== null && _a !== void 0 ? _a : new Map();
...
function successfulTypeScriptInstance(loaderOptions, loader, log, colors, compiler, compilerCompatible, compilerDetailsLogMessage) {
    ...
    if (loaderOptions.transpileOnly) {
        ...
        addTSInstanceToCache(loader._compiler, loaderOptions.instance, transpileInstance);
